...
public class SortedDoubleLinkedList_STUDENT_Test {
	...
	public Car a=new Car("Chevrolet", "Malibu", 2022);
	public Car b=new Car("Porsche", "Taycan", 2022);
	public Car c=new Car("Honda", "Civic", 2023);
	public Car d=new Car("Tesla", "Model Y", 2023);
	public Car e=new Car("Audi", "A7", 2022);
	public Car f=new Car("Cadillac", "CTS", 2012);
	//order: e f a c b d
	...
	public void testIteratorSuccessfulStringPrevious() {
		...
		assertEquals("Pig", iterator.next());
		assertEquals(true, iterator.hasPrevious());
		assertEquals("Pig", iterator.previous());
